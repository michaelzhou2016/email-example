...
public class MailServiceImpl implements MailService {
    ...
    @Override
    public void sendHtmlWithImageMail(String from, String[] to, String subject, String content, String url) throws MessagingException {
        MimeMessage message = mailSender.createMimeMessage();
        ...
        try {
            helper.addInline("snap_url", new UrlResource(url));
    ...
    public void sendPictureTemplateMail() {
        ...
        try {
            this.sendHtmlWithImageMail(from, to, "BSS客户【线下汇款】申请", emailContent, "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1576508932107&di=6f8dd77ea79ce49f23090f011ebe49c5&imgtype=0&src=http%3A%2F%2Ffile02.16sucai.com%2Fd%2Ffile%2F2014%2F0704%2Fe53c868ee9e8e7b28c424b56afe2066d.jpg");
        } catch (MessagingException e) {
            e.printStackTrace();
        }
    }
